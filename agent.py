...
her fallback ~%40 ihtimalle ölümcül bir yazı-turaydı; ayrıca kabul ölçütünün
`COMPOSED_SYSTEM_PROMPT`'a yazılması — 173 adayın Calmar dağılımı),
[[auto_arama_ekonomisi]] (çıtaya uzaklığın haritası ve rastgele tabanın
zeki yolu geçmesi),
