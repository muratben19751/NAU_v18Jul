...
#
# Adım 1: _BUILTIN_META extracted to block_meta.py. Adım 2: the 9 classic
# blocks' eval/snapshot/on_start/lookback/validate functions extracted to
# block_library_classic.py. Both re-imported below (ruff's isort sorts them
# alphabetically by module name, ahead of this comment's own Adım order) —
# BLOCK_REGISTRY, further down, still reads them all; that dict itself
# stays in this file, the registry core is out of this session's scope.
