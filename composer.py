...
# Adım 1: _BUILTIN_META extracted to block_meta.py, imported back below
# (BLOCK_REGISTRY, further down, still reads it — that dict itself stays
# in this file; the registry core is out of this session's scope).
